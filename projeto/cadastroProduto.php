...
<head>
	...
	//	var_dump($_FILES['foto']);
		//array(6) { ["name"]=> string(11) "Cliente.png" ["full_path"]=> string(11) "Cliente.png" ["type"]=> string(9) "image/png" ["tmp_name"]=> string(23) "C:\xampp\tmp\php9B7.tmp" ["error"]=> int(0) ["size"]=> int(10106) }
		// 2 mb = 209153 by
