...
if (f.tipo.value == "HARDWARE") {
	...
	<body>
		...
		$fabricante = isset($_POST['fabrigante']) ? $_POST['fabrigante'] : '';
		...
		$ativo = isset($_POST['ativo']) ? $_POST['ativo'] : true;
		 ...
		 if(isset($_FILES['foto'])){
			...
			if($deu_certo){
				$sql_code = "INSERT INTO produtos VALUES (NULL, '$nome' , '$tipo' , '$categoria' , '$fabricante' , '$descricao',
				'$caminho', true)";
				$sql_query = $conexao->query($sql_code) or die("Falha na execução do código SQL: ". $conexao->error . 
				"<br>" . var_dump($conexao->error));
