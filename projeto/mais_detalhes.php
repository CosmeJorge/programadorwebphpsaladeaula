...
<head>
    ...
    if ($sql_query->num_rows > 0) {
        ...
        $saldo2 = $totalEntrada->fetch_assoc();
    ...
    include_once 'carrinhoGerencia.php';
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="produtos.php" type="button" class="btn btn-outline-warning">Lista de Produtos</a><a href="?<?='id='. $id ."&adicionar=". $objEstoque->getProduto()->getIdProduto()  ?>" <?= (!isset($estoque['qtd']) || $estoque['qtd'] < 1 ) ?'hidden' : '' ?> type="button" class="btn btn-outline-success">Adicionar ao carrinho</a>
            </div>
        </div>
		</main>
<?php
